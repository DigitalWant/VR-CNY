...
function assetsPrepare(gender) {
  ...
  //face part object
  oHead = new Head(0, 0, 0, 0, 340, 570, oFaceImage);
  oFringe = new Fringe(0, 0, 0, 0, 340, 570, oFringeImage);
  oEye = new Eye(0, 0, 0, 0, 340, 570, oEyesImage);
  oEyebrow = new Eyebrow(0, 0, 0, 0, 340, 570, oEyebrowImage);
  oMouth = new Mouth(0, 0, 0, 0, 340, 570, oMouthsImage);
  ...
  oBackground = new Background(0, 0, 0, 0, 340, 570, oBackgroundImage);
